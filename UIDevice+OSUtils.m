...
#import "UIDevice+OSUtils.h"
#import <sys/sysctl.h>
@implementation UIDevice (OSUtils)
+ (NSString *)platform {
    size_t size;
...
+ (NSString *)platformString {
    ...
    // iPad
    if ([platform isEqualToString:@"iPad12,2"])      return @"iPad 9 (Cellular)";
    if ([platform isEqualToString:@"iPad12,1"])      return @"iPad 9 (WiFi)";
    if ([platform isEqualToString:@"iPad11,6"])      return @"iPad 8 (Cellular)";
    if ([platform isEqualToString:@"iPad11,7"])      return @"iPad 8 (WiFi)";
